...
pyinstaller --onefile --windowed --noconfirm --name FotoRotator --collect-data customtkinter --collect-data pillow_heif --collect-data pytesseract --hidden-import pystray._win32 run.py
